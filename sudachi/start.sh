...
wget -q http://sudachi.s3-website-ap-northeast-1.amazonaws.com/sudachidict/sudachi-dictionary-20240409-full.zip

unzip sudachi-0.7.3-executable.zip
unzip sudachi-dictionary-20240409-full.zip
